...
import UpgrageButton from "@/components/UpgrageButton";
    ...
    <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
      <div className="mx-auto mb-10 sm:max-w-lg">
        ...
        <p className="mt-5 text-gray-600 sm:text-lg">
          Whether you&apos;re exploring our services or seeking more, we&apos;ve
          got you covered. Choose excellence with us.
        </p>
      </div>
